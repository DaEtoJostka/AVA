...
input_video_path = '/home/trisolaris/projects/hahatons/AutoVidNet/test.mp4'

# Путь для сохранения выходного видео
output_video_path = 'cock.mp4'

# Путь для сохранения аннотаций
annotations_path = 'annotations.csv'

# Загрузка модели
model = YOLO('backend/yolov10s.pt')
...
def compress_video(input_file, output_file, crf=23, preset='medium'):
    try:
        ...
        print(f"Видео успешно сжато и сохранено как {output_file}")
    except ffmpeg.Error as e:
        print(f"Ошибка при сжатии видео: {e.stderr.decode()}")


compress_video("cock.mp4", "cock1.mp4", crf=23, preset='medium')
